...
//		ElevatorDoor elevatorDoor1 = ElevatorDoorFactory.createElevatorDoor(DeviceVendor.Samsung);
...
//				elevatorMotor1, elevatorDoor1, floorDoors1, doorTimer1);
		...
		ElevatorController elevatorController1 = new ElevatorController(
				DeviceVendor.Samsung, elevatorMotor1, floorDoors1, doorTimer1);
...
//					elevatorMotor2, elevatorDoor2, floorDoors2, null);
		ElevatorController elevatorController2 = new ElevatorController( //(step2)
                DeviceVendor.Hyundai, elevatorMotor2, floorDoors2, null);
